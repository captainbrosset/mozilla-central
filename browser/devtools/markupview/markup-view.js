...
MarkupView.prototype = {
  ...
  _expandContainer: function MT__expandContainer(aContainer)
  {
    return this._updateChildren(aContainer, true).then(() => {
      // FIXME !!!! FOR SOME REASON WHEN THE UPDATECHILDREN PROMISE ENDS, THE 
      // CONTAINER HAS NO CHILDREN, EVEN IF IT REALLY DOES. SO THE EXPAND WONT
      // DO ANYTHING!!! FIND A WAY TO UNDERSTAND WHAT'S GOING ON IN THE UPDATECHILDREN AND FIX IT!!
